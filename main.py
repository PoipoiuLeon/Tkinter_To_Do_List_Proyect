...
class ToDoListApp:
    def __init__(self, root):
        ...
        selected_description_label = Label(frame, textvariable=self.selected_description, wraplength=110)
        ...
        new_label = Label(frame, text="Item name")
        new_label.grid(column=2, row=2, sticky=(S, W))
        ...
        save_button.grid(column=12, row=6, sticky=(E))
